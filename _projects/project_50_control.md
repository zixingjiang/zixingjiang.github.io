...
This project aims to design a control framework for the manipulator to overcome wave disturbances and accurately capture the UAV. The task can be expressed as **objective catching on a disturbed platform**. For simplification, in achieving this task, we assume
